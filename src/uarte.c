...
nrfx_err_t
uarte_init(NRF_UARTE_Type* p_reg, uint32_t tx_pin, uint32_t rx_pin)
{
    ...
    nrf_uarte_txrx_pins_set(p_reg, tx_pin, rx_pin);
...
nrfx_err_t
uarte_rx_dma_start(NRF_UARTE_Type* p_reg, uarte_modem_irq_t irq_handler,
    unsigned char* rx_buf, size_t buf_len)
{
